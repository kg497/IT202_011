        ...
        <div class="collapse navbar-collapse" id="navContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <?php if (is_logged_in()) : ?>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo get_url('user_history.php'); ?>">Purchase History</a></li>
                <?php endif; ?>
                <?php if (!is_logged_in()) : ?>
                ...
                <?php if (has_role("Admin")) : ?>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo get_url('admin/purchase_history.php'); ?>"> All Purchase History</a></li>
                   
                <?php endif; ?>
                <?php if (is_logged_in()) : ?>
                    <li class="nav-item"><a class="nav-link" href="<?php echo get_url('logout.php'); ?>">Logout</a></li>
                <?php endif; ?>
                <li class="nav-item"><a class="nav-link" href="<?php echo get_url('shop.php'); ?>">Order</a></li>
            </ul>
        </div>
    </div>
</nav>